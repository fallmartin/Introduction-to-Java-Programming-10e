 ...
 * The program prompts the user to enter the year and the month, then displays
 * the entire calendar for the month, as shown in the following sample run.
 * 
 * See textbook for sample output.
 * 
 * Output:
           March 2012
-----------------------------
