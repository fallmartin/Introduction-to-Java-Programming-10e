...
public class MyLinkedList<E> extends MyAbstractList<E> {
     ...
     *
     * @param e the element that we're searching for in this list
    ...
    public boolean contains(E e) {
        ...
        for (int i = 0; i < size; i++) {
            // If the current element is e
            if (current.element.equals(e)) {
                return true; // return true
            } else { // else look at the next node in this list
                current = current.next;
            }
        }
    ...
    public E set(int index, E e) {
        ...
        // Remember the removed element to return later
        E removedElement = current.element;

        // Set the element of the current node to e
        current.element = e;
